...
class GatedAttentionNet(nn.Module):
    """
    Gated attention module for MIL instance weighting.
    """
...
class AttentionMILModel(nn.Module):
    """
    Attention-based MIL model supporting classification and regression.
    ...
    Args:
        ...
        dropout: Whether to enable dropout inside the attention block.
    """
    ...
    def forward(self, instance_feature: torch.Tensor):
        """
        Args:
            instance_feature: Tensor with shape (N, D) or (1, N, D).

        Returns:
            logits: Model output.
            bag_feature: Aggregated bag-level representation.
